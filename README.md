...
Current development version: v0.13.60
...
Discovery is separate from saved listening profiles. Changing the Windows default output does not automatically change `listening_mode` or a profile delay in v0.13.60.
