...
|---|---|---|---|---|---|
| HUM-00 | Portable product core | Windows behavior stays intact while platform assumptions are isolated | Ready | None | [Contract](roadmap/1.0/HUM-00-portable-product-core.md) |
